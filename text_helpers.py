...
def generate_batch_data(sentences, batch_size, window_size, method='skip_gram'):
    ...
    while len(batch_data) < batch_size:
        ...
        if method=='skip_gram':
            ...
            if not batch_and_labels :
                continue
            else:
                batch, labels = map(list, zip(*batch_and_labels))
...
def load_movie_data(data_folder_name):
    ...
    if os.path.isfile(pos_file):
        ...
        movie_data_url = 'https://www.cs.cornell.edu/people/pabo/movie-review-data/rt-polaritydata.tar.gz'
